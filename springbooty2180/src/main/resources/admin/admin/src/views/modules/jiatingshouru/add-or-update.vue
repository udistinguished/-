    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="账户号" prop="zhanghuhao">
                        <el-input v-model="ruleForm.zhanghuhao"
                                  placeholder="账户号" clearable :readonly="ro.zhanghuhao"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="账户号" prop="zhanghuhao">
                            <el-input v-model="ruleForm.zhanghuhao"
                                      placeholder="账户号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'" label="收入分类" prop="shourufenlei">
                        <el-select v-model="ruleForm.shourufenlei" placeholder="请选择收入分类">
                            <el-option
                                    v-for="(item,index) in shourufenleiOptions"
                                    v-bind:key="index"
                                    :label="item"
                                    :value="item">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="收入分类" prop="shourufenlei">
                            <el-input v-model="ruleForm.shourufenlei"
                                      placeholder="收入分类" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
        ...
        methods: {
            ...
            init(id, type) {
                ...
                if (this.type == 'info' || this.type == 'else') {
                    ...
                    for (var o in obj) {
                        ...
                        if (o == 'shourufenlei') {
                            this.ruleForm.shourufenlei = obj[o];
                            this.ro.shourufenlei = true;
                            continue;
                        }
                        if (o == 'jine') {
                ...
                this.$http({
                    url: `option/shourufenlei/shourufenlei`,
                    method: "get"
                }).then(({data}) => {
                    if (data && data.code === 0) {
                        this.shourufenleiOptions = data.data;
                    } else {
                        this.$message.error(data.msg);
                    }
                });
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url: `jiatingshouru/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({data}) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiatingshouruCrossAddOrUpdateFlag = false;
                                        this.parent.search();
