    ...
    <div class="addEdit-block">
        ...
        >
            ...
            <el-form-item class="btn">
                <el-button v-if="type!='info'" type="primary" class="btn-success"
                           style="background-color: rgba(208, 163, 140, 0.53)" @click="onSubmit">提交
                </el-button>
                <el-button v-if="type!='info'" class="btn-close" @click="back()">取消</el-button>
                <el-button v-if="type=='info'" class="btn-close" style="background-color: rgba(208, 163, 140, 0.53)"
                           @click="back()">返回
                </el-button>
            </el-form-item>
        </el-form>
