<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" label="用户名" prop="yonghuming" v-if="type!='info'">
                        <el-input :readonly="ro.yonghuming"
                                  clearable placeholder="用户名" v-model="ruleForm.yonghuming"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="用户名" prop="yonghuming">
                            <el-input placeholder="用户名"
                                      readonly v-model="ruleForm.yonghuming"></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" label="用户姓名" prop="yonghuxingming" v-if="type!='info'">
                        <el-input :readonly="ro.yonghuxingming"
                                  clearable placeholder="用户姓名" v-model="ruleForm.yonghuxingming"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="用户姓名" prop="yonghuxingming">
                            <el-input placeholder="用户姓名"
                                      readonly v-model="ruleForm.yonghuxingming"></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" label="账户号" prop="zhanghuhao" v-if="type!='info'">
                        <el-input :readonly="ro.zhanghuhao"
                                  clearable placeholder="账户号" v-model="ruleForm.zhanghuhao"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="账户号" prop="zhanghuhao">
                            <el-input placeholder="账户号"
                                      readonly v-model="ruleForm.zhanghuhao"></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" label="金额" prop="jine" v-if="type!='info'">
                        <el-input :readonly="ro.jine"
                                  clearable placeholder="金额" v-model="ruleForm.jine"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="金额" prop="jine">
                            <el-input placeholder="金额"
                                      readonly v-model="ruleForm.jine"></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
            <el-form-item class="btn">
                <el-button @click="onSubmit" class="btn-success" type="primary" v-if="type!='info'">提交</el-button>
                <el-button @click="back()" class="btn-close" v-if="type!='info'">取消</el-button>
                <el-button @click="back()" class="btn-close" v-if="type=='info'">返回</el-button>
            </el-form-item>
        </el-form>
        ...
        methods: {
            ...
            init(id, type) {
                ...
                if (this.type == 'info' || this.type == 'else') {
                    ...
                    for (var o in obj) {
                        ...
                        if (o == 'zhanghuhao') {
                            this.ruleForm.zhanghuhao = obj[o];
                            this.ro.zhanghuhao = true;
                            continue;
                        }
                        if (o == 'jine') {
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url: `jiatingzhanghu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({data}) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiatingzhanghuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
