    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'" label="债务类型" prop="touzileixing">
                        <el-select v-model="ruleForm.touzileixing" placeholder="请选择债务类型">
                            <el-option
                                    v-for="(item,index) in touzileixingOptions"
                                    v-bind:key="index"
                                    :label="item"
                                    :value="item">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="债务类型" prop="touzileixing">
                            <el-input v-model="ruleForm.touzileixing"
                                      placeholder="债务类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="债务账户" prop="touzizhanghu">
                        <el-input v-model="ruleForm.touzizhanghu"
                                  placeholder="债务账户" clearable :readonly="ro.touzizhanghu"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="债务账户" prop="touzizhanghu">
                            <el-input v-model="ruleForm.touzizhanghu"
                                      placeholder="债务账户" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="债务人名" prop="mingcheng">
                        <el-input v-model="ruleForm.mingcheng"
                                  placeholder="债务人名" clearable :readonly="ro.mingcheng"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="债务人名" prop="mingcheng">
                            <el-input v-model="ruleForm.mingcheng"
                                      placeholder="债务人名" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="债务金额" prop="jine">
                        <el-input v-model="ruleForm.jine"
                                  placeholder="债务金额" clearable :readonly="ro.jine"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="债务金额" prop="jine">
                            <el-input v-model="ruleForm.jine"
                                      placeholder="债务金额" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="date" v-if="type!='info'" label="发生时间" prop="touzishijian">
                        <el-date-picker
                                format="yyyy 年 MM 月 dd 日"
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.touzishijian"
                                type="date"
                                placeholder="发生时间">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" v-if="ruleForm.touzishijian" label="发生时间" prop="touzishijian">
                            <el-input v-model="ruleForm.touzishijian"
        ...
        data() {
            ...
            return {
                addEditForm: {
                    ...
                    "btnSaveBgColor": "rgba(208, 163, 140, 0.53)",
        ...
        methods: {
            ...
            init(id, type) {
                ...
                if (this.type == 'info' || this.type == 'else') {
                    ...
                    for (var o in obj) {
                        ...
                        if (o == 'touzizhanghu') {
                            this.ruleForm.touzizhanghu = obj[o];
                            this.ro.touzizhanghu = true;
                            continue;
                        }
                        if (o == 'mingcheng') {
                        ...
                        if (o == 'touzishijian') {
                            this.ruleForm.touzishijian = obj[o];
                            this.ro.touzishijian = true;
                            continue;
                        }
                    }
                }
                ...
                this.touzileixingOptions = "房屋抵押贷款,车辆贷款,亲朋借贷,花呗,其他".split(',')
            },
            // 多级联动参数
            info(id) {
                this.$http({
                    url: `touzilicai/info/${id}`,
                    method: "get"
                }).then(({data}) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url: `touzilicai/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({data}) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.touzilicaiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
