<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="支出分类" prop="zhichufenlei">
                        <el-input v-model="ruleForm.zhichufenlei"
                                  placeholder="支出分类" clearable :readonly="ro.zhichufenlei"></el-input>
                    </el-form-item>
                    <div v-else>
        ...
        methods: {
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url: `zhichufenlei/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({data}) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.zhichufenleiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
