<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="收入分类" prop="shourufenlei">
                        <el-input v-model="ruleForm.shourufenlei"
                                  placeholder="收入分类" clearable :readonly="ro.shourufenlei"></el-input>
                    </el-form-item>
                    <div v-else>
        ...
        methods: {
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url: `shourufenlei/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({data}) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shourufenleiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
