  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(208, 163, 140, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">家庭记账管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<div style="display: flex;flex-wrap: wrap;width: 100%;justify-content: center;">
				...
				<el-button style="margin-left:10px;margin-top: 10px;border:1px rgba(249, 104, 104, 0.9) solid;" class="btn close" type="primary" @click="close()">取消</el-button>
			</div>
		</el-form>
      </div>
