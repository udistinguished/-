    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'" label="支出分类" prop="zhichufenlei">
                        <el-select v-model="ruleForm.zhichufenlei" placeholder="请选择支出分类">
                            <el-option
                                    v-for="(item,index) in zhichufenleiOptions"
                                    v-bind:key="index"
                                    :label="item"
                                    :value="item">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="支出分类" prop="zhichufenlei">
                            <el-input v-model="ruleForm.zhichufenlei"
                                      placeholder="支出分类" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
        ...
        methods: {
            ...
            init(id, type) {
                ...
                if (this.type == 'info' || this.type == 'else') {
                    ...
                    for (var o in obj) {
                        ...
                        if (o == 'zhichufenlei') {
                            this.ruleForm.zhichufenlei = obj[o];
                            this.ro.zhichufenlei = true;
                            continue;
                        }
                        if (o == 'jine') {
                ...
                this.$http({
                    url: `option/zhichufenlei/zhichufenlei`,
                    method: "get"
                }).then(({data}) => {
                    if (data && data.code === 0) {
                        this.zhichufenleiOptions = data.data;
                    } else {
                        this.$message.error(data.msg);
                    }
                });
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url: `jiatingzhichu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({data}) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiatingzhichuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
