                ...
                <el-row :gutter="20" class="slt"
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '用户名' : ''">
                        <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1"
                                  prefix-icon="el-icon-search" v-model="searchForm.username" placeholder="用户名"
                                  clearable></el-input>
                        <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2"
                                  suffix-icon="el-icon-search" v-model="searchForm.username" placeholder="用户名"
                                  clearable></el-input>
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('users','查看') && contents.tableBtnIcon == 0" type="success"
                            ...
                            <el-button v-if="isAuth('users','修改') && contents.tableBtnIcon == 0" type="primary"
                            ...
                            <el-button v-if="isAuth('users','删除') && contents.tableBtnIcon == 0" type="danger"
